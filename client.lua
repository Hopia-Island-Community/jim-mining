...
RegisterNetEvent('jim-mining:SellOre', function()
	exports['qb-menu']:openMenu({
		...
		{ header = "<img src=nui://"..Config.img..QBCore.Shared.Items["copper"].image.." width=30px>"..Loc[Config.Lan].info["copper"], txt = Loc[Config.Lan].info["sell_all"].." "..Config.SellItems['copper'].." "..Loc[Config.Lan].info["sell_each"], params = { event = "jim-mining:SellAnim", args = 'copper' } },
